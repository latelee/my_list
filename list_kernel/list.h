/**
Simple doubly linked list implementation from linux kernel,
modified by Late Lee for C&C++
*/

#ifndef _MY_LINUX_LIST_H
#define _MY_LINUX_LIST_H
...
/**
 * list_replace - replace old entry by new1 one
 * @old : the element to be replaced
 * @new1 : the new1 element to insert
 *
 ...
 * @list: a new1 list to add all removed entries
...
#define list_add_prev list_add_tail
